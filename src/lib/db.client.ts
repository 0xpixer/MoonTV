...
// ---- 常量 ----
const PLAY_RECORDS_KEY = 'tintintv_play_records';
const FAVORITES_KEY = 'tintintv_favorites';
const SEARCH_HISTORY_KEY = 'tintintv_search_history';

// 缓存相关常量
const CACHE_PREFIX = 'tintintv_cache_';
